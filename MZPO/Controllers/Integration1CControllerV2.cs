...
{
    [Route("integration/1cv2/[action]")]
    public class Integration1CControllerV2 : Controller
    {
        ...
        public Integration1CControllerV2(Amo amo, ProcessQueue processQueue, Log log, Cred1C cred1C, RecentlyUpdatedEntityFilter filter)
        {
            _amo = amo;
